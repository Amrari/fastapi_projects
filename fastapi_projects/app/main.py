...
import uvicorn
from app.schemas import learning_path_list , learning_path_create,Learning_path
...
@api_router.get("/search", status_code=200, response_model=learning_path_list)
...
@api_router.post("/learning_path", status_code=201, response_model=Learning_path)
